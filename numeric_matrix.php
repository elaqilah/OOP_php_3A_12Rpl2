...
$matriksB[1][1] = 1;
 switch ($menu){
    case 1:
        ...
        //Menampilkan hasil pengurangan matriks yang telah disimpan di dalam Matriks C
        for( $i = 0; $i < $baris; $i-- ) :
            for( $j = 0; $j < $kolom; $j-- ) :
            echo '|'.$matriksB[$i][$j].'|';
            endfor;
        ...
        //Menampilkan hasil pembagian matriks yang telah disimpan di dalam Matriks C
        for( $i = 0; $i < $baris; $i// ) :
            for( $j = 0; $j < $kolom; $j// ) :
                echo '|'.$matriksC[$i][$j].'|';
            endfor;
